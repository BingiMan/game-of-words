    ...
    return (
      <div className='game-main-container'>
            ...
            <div className='game-content-wrapper'>
              ...
              {/*<li>{this.props.word.results[0].typeOf}</li>*/}
              {
                this.randomizeWord(this.state.word).map(character => {
                  return <div className='random-word'> {character} </div>;
                })
              }
            </div>
            : null}
        ...
        <div className='game-input'>
          <Input rightWord={this.state.word} matchWord2={this.checkIfWordMatches.bind(this)} gameOverDisplay={this.props.gameOverDisplay} />
        </div>
      </div>
    )
  }
